...
function M.get(c, opts)
  ...
  return {
    ...
    BufferCurrentWARN     = { bg = c.bg, fg = c.warn },
    BufferCurrentIndex    = { bg = c.bg, fg = c.info },
    BufferCurrentMod      = { bg = c.bg, fg = c.warn },
    BufferCurrentSign     = { bg = c.bg, fg = c.bg },
    BufferCurrentTarget   = { bg = c.bg, fg = c.red },
    BufferAlternate       = { bg = c.secondary, fg = c.fg },
    BufferAlternateERROR  = { bg = c.secondary, fg = c.error },
    BufferAlternateHINT   = { bg = c.secondary, fg = c.hint },
    BufferAlternateIndex  = { bg = c.secondary, fg = c.info },
    BufferAlternateINFO   = { bg = c.secondary, fg = c.info },
    BufferAlternateMod    = { bg = c.secondary, fg = c.warning },
    BufferAlternateSign   = { bg = c.secondary, fg = c.info },
    BufferAlternateTarget = { bg = c.secondary, fg = c.red },
    BufferAlternateWARN   = { bg = c.secondary, fg = c.warning },
